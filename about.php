        ...
        <div id="site-content" class="site-content">
            ...
            <div class="content-header content-header-inline wrap">
                <div class="content-header-inner wrap">
                    <!--<h2>WHO WE ARE</h2>-->
                    <h2 class="main-headig">Our story</h2>
                </div>
            </div>
                    ...
                    <main id="main-content" class="main-content" itemprop="mainContentOfPage">
                        <div class="main-content-inner">
                            ...
                            <div class="content text-content shadow content-padding">
                                <!--<img src="assets/Our_Team.jpg" style="width: 100%;" alt="SFR Medical team members">-->
                                ...
                                <ul>
                                    ...
                                    <li>only physicians can translate hospital notes into court-ready medical evidence reports</li>
                                    <li>reports must be written on-site at a hospital, often after long shifts, but writing reports are not part of a physician’s NHS responsibilities</li>
                                    <li>the police must contract with individual doctors and constantly chase them to get the reports</li>
                                    <li>one in eight reports are returned for poor quality because doctors are not trained to write them</li>
                                    <li>given the lag in production, urgent report requests are prohibitive</li>
                                    <li>only 15% of reports are paid for, leading to an unwillingness to write them</li>
                                </ul>
                                <div class="vc_empty_space" style="height: 20px"><span class="vc_empty_space_inner"></span></div>
                                <p>And because there were so many issues, no one looked for a solution … until now.</p>
                                ...
                                <!-- <div class="vc_row wpb_row vc_inner vc_row-fluid" style="padding:20px 0;">
                                    <div class="wpb_column vc_column_container vc_col-md-6 vc_col-sm-12">
                                        <div class="vc_column-inner">
                                            <div class="wpb_wrapper text-content ">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="wpb_column vc_column_container vc_col-md-6 vc_col-sm-12">
