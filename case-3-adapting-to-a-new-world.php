        ...
        <div id="site-content" class="site-content">
            ...
            <div class="content-header content-header-inline wrap">
                <div class="content-header-inner wrap ">
                    <!--<h2>WHO WE ARE</h2>-->
                    <h2 class="main-headig">Adapting to a new world</h2>
                </div>
            </div>
                                ...
                                <div id="post-1709" class="post post-1709 single-post">
                                    <div class="post-inner">
                                        <div class="post-header">
                                            <h2 class="post-title" itemprop="headline" style="display: none;">Adapting to a new world<br /></h2>
                                            ...
                                            <div class="post-meta-group">
                                                <ul class="meta-header">
                                                    ...
                                                    <li class="post-date">
                                                        ...
                                                        <span class="post-day">April 23, 2020</span>
                                                    </li>
                                                </ul>
                                            </div>
                                        ...
                                        <div class="post-thumbnail">
                                            <img src="assets/blog3.jpg" class="attachment-post-thumbnail size-post-thumbnail wp-post-image img-responsive" alt="Adapting to a new world" />
                                        </div>
                                        <!-- /.post-thumbnail -->
