        ...
        <div id="site-content" class="site-content">
            ...
            <div class="content-header content-header-inline wrap">
                <div class="content-header-inner wrap ">
                    <!--<h2>WHO WE ARE</h2>-->
                    <h2 class="main-headig">Privacy & Policy</h2>
                </div>
            </div>
                    ...
                    <main id="main-content" class="main-content" itemprop="mainContentOfPage">
                        <div class="main-content-inner">
                            <div class="content text-content shadow content-padding">
                                ...
                                <p><b>Controller</b>: Streamlined Forensic Reporting Limited is the controller and responsible for your personal data (collectively referred to as Streamlined Forensic Reporting Limited, "we", "us" or "our" in this Privacy Policy).</p>
                                ...
                                <ul>
                                    ...
                                    <li>Email address: contact@sfrmedical.com</li>
                                    <li>Telephone number: 01234943111, Option 3</li>
                                </ul>
                                ...
                                <p>We keep our Privacy Policy under regular review. This version was last updated on 5 November 2020.</p>
                                ...
                                <ul>
                                    ...
                                    <li><b>Profile data</b> includes information similar to your identity data plus contact information along with any requests you may have made to us.</li>
                                ...
                                <table class="table table-bordered" style="width: 100%;">
                                    <thead>
                                        <tr>
                                            <th style="vertical-align: top; font-weight: 700;">Purpose (activity)</th>
                                            <th style="vertical-align: top; font-weight: 700;">Type of data</th>
                                            <th style="vertical-align: top; font-weight: 700;">Lawful basis for processing including basis of legitimate interest</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr>
