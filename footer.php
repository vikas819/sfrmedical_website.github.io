            ...
            <div class="footer-copyright footer-copyright-left">
                <div class="footer-copyright-inner wrap">
                    <div class="copyright-content">
                        <img src="assets/logo.png" alt="SFR Medical" width="120">
                        <span>© Streamlined Forensic Reporting Limited<br>Company number 11401401<br>Trading as SFR Medical  <br>
                            <a title="Cookie Policy" href="#" data-toggle="modal" data-target="#myCookies">Cookie Policy</a>&nbsp;&nbsp;
                            <a title="Privacy Policy" href="#" data-toggle="modal" data-target="#myModal">Privacy Policy</a>
                        </span>    
                    </div>
                    <!-- <div class="footer-privacy">
                        <span style="float:right;"> 
                            <a title="" href="#"  data-toggle="modal" data-target="#myCookies" style="font-size: 16px;">Cookie Policy</a>&nbsp;&nbsp;
                            <a title="" href="#"  data-toggle="modal" data-target="#myModal" style="font-size: 16px;">Privacy Policy</a>
                        </span> 
                    </div> -->
                    <div class="footer-meta">
                        ...
                        <div class="go-to-top">
                            <a title="Digital Marketplace supplier - STREAMLINED FORENSIC REPORTING LIMITED" href="https://www.applytosupply.digitalmarketplace.service.gov.uk/g-cloud/supplier/718218" target="_blank"><img src="assets/gov-logo-1 1.png" alt="Digital Marketplace supplier - STREAMLINED FORENSIC REPORTING LIMITED" title="Digital Marketplace supplier - STREAMLINED FORENSIC REPORTING LIMITED" ></a>
                            <img src="assets/ce.png" alt="Cyber Essentials" id="img3">
                            <a title="PolicyBee professional insurance broker" rel='nofollow' href="https://www.policybee.co.uk/" target="_blank">
                                <img src="https://www.policybee.co.uk/_img/badge/Green_PolicyBee_Badge.png" alt="PolicyBee professional insurance broker" title="PolicyBee professional insurance broker" id="img1" />
                            </a>
                            <img src="assets/ico.jpg" title="Information Commissioner's office" alt="Information Commissioner's office" id="img2">
                            <img src="assets/Approachable_UKAS_1.jpg" title="Certificate Number: 11989-ISMS-001" alt="Certificate Number: 11989-ISMS-001" id="img4">
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div id="off-canvas-right" class="off-canvas sliding-menu">
        <a title="toggle" href="#" data-target="off-canvas-right" class="off-canvas-toggle">
            <span></span>
        </a>
        ...
        <div class="off-canvas-wrap">
            ...
            <ul id="menu-mobile-1" class="menu menu-sliding dw-mega-menu-transition-default">
                <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-home page_item page-item-7 item-153"><a title="SFR Medical" href="<?php echo $url;?>">HOME </a> </li> 
                <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children menu-flyout dw-mega-menu-hover item-154"><a title="What we do" href="#">WHAT WE DO</a>
                    <ul class="dw-sub-menu">
                        <li class="menu-item menu-item-type-post_type menu-item-object-page dw-mega-menu-hover item-945"><a title="For police" href="#">For police</a>
                            <ul class="dw-sub-menu">
                                ...
                                <li class="menu-item menu-item-type-post_type menu-item-object-page dw-mega-menu-hover item-945"><a title="For police our productsOur products" href="<?php echo $url;?>for-police-our-products">Our products</a></li>
                            </ul>
                        </li>
                ...
                <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children menu-flyout dw-mega-menu-hover item-155"><a title="About us" href="#">ABOUT US</a>
                    <ul class="dw-sub-menu">
                        <li class="menu-item menu-item-type-post_type menu-item-object-page dw-mega-menu-hover"><a title="Our team" href="<?php echo $url;?>our-team">Our team</a></li>
                        <li class="menu-item menu-item-type-post_type menu-item-object-page dw-mega-menu-hover"><a title="Awards & recognition" href="<?php echo $url;?>awards-and-recognition">Awards & recognition</a></li>
                        <li class="menu-item menu-item-type-post_type menu-item-object-page dw-mega-menu-hover"><a title="News & posts" href="<?php echo $url;?>news-and-posts">News & posts</a></li>
                        <li class="menu-item menu-item-type-post_type menu-item-object-page dw-mega-menu-hover"><a title="Testimonials" href="<?php echo $url;?>testimonials">Testimonials</a></li>
                    </ul>
                </li>
                <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children menu-flyout dw-mega-menu-hover item-156"><a title="Partner with us" href="#">PARTNER WITH US</a>
                    <ul class="dw-sub-menu">
                        <li class="menu-item menu-item-type-post_type menu-item-object-page dw-mega-menu-hover"><a title="Contracting process" href="<?php echo $url;?>contracting-process">Contracting process</a></li>
                        <li class="menu-item menu-item-type-post_type menu-item-object-page dw-mega-menu-hover"><a title="Procurement process" href="<?php echo $url;?>procurement-process">Procurement process</a></li>
                        <li class="menu-item menu-item-type-post_type menu-item-object-page dw-mega-menu-hover"><a title="Governance & compliance" href="<?php echo $url;?>governance-and-compliance">Governance & compliance</a></li>
                    </ul>
                </li>
                <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-home page_item page-item-7 item-158"><a title="Contact us" href="<?php echo $url;?>contact-us">CONTACT US</a>
                </li>
                <!--<li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-home page_item page-item-7 item-159"><a title="" href="https://portal.sfrmedical.co.uk/" target="_blank">CLIENT LOGIN</a>-->
                <!--</li>-->
            </ul>
            <p class="mobile-menu-text"><i class="fa fa-phone"></i> &nbsp;Need help? Talk to an expert <br>+44 1234 943 111</p>
            <!--<div class="social-icons">-->
    ...
    <script type='text/javascript' src='<?php echo $url;?>assets/js/components8a54.js?ver=1.0.0'></script>
    <script type='text/javascript' src='<?php echo $url;?>assets/js/theme8a54.js?ver=1.0.0'></script>
    <script type='text/javascript' src='<?php echo $url;?>assets/dw-mega-menu/assets/js/dw-megamenuaead.js?ver=5.0.3'></script>
    <script type='text/javascript' src='<?php echo $url;?>assets/js_composer/assets/js/dist/js_composer_front.min40df.js?ver=5.6'></script>
    
    <script type='text/javascript' src='<?php echo $url;?>assets/line-shortcodes/js/shortcodes-3rd8a54.js?ver=1.0.0'></script>
    <script type='text/javascript' src='<?php echo $url;?>assets/line-shortcodes/js/shortcodes8a54.js?ver=1.0.0'></script>

    
    
    <!-- Global site tag (gtag.js) - Google Analytics integrated by Kamlesh Yaduwanshi 22nd April 2020 -->
    <script async src="https://www.googletagmanager.com/gtag/js?id=UA-164286304-1"></script>
    <script>
    ...
    <!-- <script type='text/javascript' src='<?php echo $url;?>assets/js/cookies.js'></script>
    <div class="cookieinfo" style="">
        <div class="row" >
            ...
            <div class="col-md-4">
                <a title="Decline" href="#" class="cookieinfo-close" onclick="hideCookie();">Decline</a>
                <a title="Got it" href="#" class="cookieinfo-close" onclick="createCookie();">Got it!</a>
            </div>   
        </div>
    </div>
    <script>
...
<?php if($page == 'Home'){ ?>
     <!--<script src="<?php echo $url;?>assets/owl-carousel/jquery-1.9.1.min.js"></script>  -->
    <script src="<?php echo $url;?>assets/owl-carousel/owl.carousel.js"></script>
    <style>
        #casestudies .item{
          margin: 10px;
        }
...
.modal-diolog{max-width: 1172px !important;; width:94% !important;}
.modal-header{padding-bottom: 0;}
.modal-body{padding:30px 40px;}
.modal-body .close {margin-top: -15px;}
.modal-body .table {width: 100%;}
.modal-body .table tr th {vertical-align: top; font-weight: 700;}
.btn-download{height:auto;}
@media screen {
  #printSection {
      display: none;
  }
...
<!-- <div class="modal fade" id="myModalflowchart" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document" style="max-width: 1172px; width:94%;">
    <div class="modal-content">
      <div class="modal-header" style="padding-bottom: 0;">
      </div>
      <div class="modal-body" id="" style="padding:30px 40px;">
        ...
        <a title="SFR MEDICAL PROCESS FLOWCHART" href="<?php echo $url;?>assets/SFR MEDICAL PROCESS FLOWCHART.pdf" class="btn btn-primary btn-sm" style="height:auto;" download="" >Download</a><br><br>
        
            <img src="<?php echo $url;?>assets/SFR MEDICAL PROCESS FLOWCHART.jpg" alt="SFR MEDICAL PROCESS FLOWCHART" class="img-responsive">
  ...
  <div class="modal-dialog" role="document" style="max-width: 1172px; width:94%;">
    <div class="modal-content">
      ...
      <div class="modal-body" id="" ><!--  -->
        ...
        <a title="SFR Medical Privacy Policy" href="<?php echo $url;?>assets/SFR Medical Privacy Policy.pdf" class="btn btn-primary btn-sm btn-download" download >Download</a><br><br>
        <div >
            ...
            <ul>
                ...
                <li>Email address: <a  title="SFR Medical" href="mailto:contact@sfrmedical.com">contact@sfrmedical.com</a></li>
          ...
          <table class="table table-bordered">
            ...
            <tbody>
              <tr>
                ...
                <td>You can find out more about Google Analytics <a title="You can find out more about Google Analytics" target="_blank" href="http://www.google.com/analytics">here</a>.</td>
              </tr>
              <tr>
...
<script>
// $('#myModalflowchart').on('shown.bs.modal', function () {
...
//     printElement(document.getElementById("show_data"));
// }
