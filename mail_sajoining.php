...
if(isset($_GET['id']) && $_GET['id'] =="joining_us_form"){
      $result = "";
      ...
      $speciality = implode('|', $_POST['txt_speciality']);
      $speciality_other = $_POST['txt_speciality_other'];
      $nationality = test_input($_POST['txt_nationality']);
      ...
      if (!empty($name) && !empty($emailfrom) ) {
        ...
        $admin->runQuery("INSERT INTO `sfr_sajoining_master`(`joining_id`, `joining_fname`, `joining_lname`, `joining_email`, `joining_phone`, `joining_speciality`, `joining_speciality_other`, `joining_nationality`, `joining_doc`, `joining_msg`, `created_on`) VALUES ( '$uniqid', '$fname', '$lname', '$emailfrom', '$contact', '$speciality', '$speciality_other', '$nationality', '$document_new', '$message', '$today')");
