<?php $page = "For police - Our solution";
                                                ...
                                                <div class="member vc_custom_1515641281914 has-image">
                                                    <div class="member-content">
                                                        ...
                                                        <div class="member-info">
                                                            <div class="member-desc">
                                                                <p>
                                                                    providing a monthly invoice and a simplified payment process 
                                                                </p>
                                                            </div>
                                                        </div>
                                                    </div>
                                    ...
                                    <div class="wpb_column vc_column_container vc_col-md-6 vc_col-sm-6">
                                        <div class="vc_column-inner">
                                            <div class="wpb_wrapper text-content text-left">
                                                ...
                                                <a class="next_prev" href="<?php echo $url;?>for-police-our-purpose"><i class="fa fa-chevron-left" aria-hidden="true"></i>&nbsp;&nbsp;Our purpose</a>
                                                <div class="vc_empty_space h-10"><span class="vc_empty_space_inner"></span></div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="wpb_column vc_column_container vc_col-md-6 vc_col-sm-6">
                                        <div class="vc_column-inner">
                                            <div class="wpb_wrapper text-content text-right" >
                                                <div class="vc_empty_space h-10"><span class="vc_empty_space_inner"></span></div>
                                                <a class="next_prev" href="<?php echo $url;?>for-police-our-products">Our products&nbsp;&nbsp;<i class="fa fa-chevron-right" aria-hidden="true"></i></a>
                                                <div class="vc_empty_space h-10"><span class="vc_empty_space_inner"></span></div>
                                            </div>
                                        </div>
                                    </div>
